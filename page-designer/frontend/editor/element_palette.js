...
import {FieldIcon, TextIcon, ImageIcon, BarcodeIcon, QrIcon, LineIcon} from '../ui/icons.js';
        ...
        <div className="flex w-max items-center gap-1">
            {ITEMS.map(({kind, icon: Icon}) => (
                <button
                    ...
                    type="button"
                    onClick={() => onAdd(kind)}
                    className="flex h-7 shrink-0 items-center gap-1.5 whitespace-nowrap rounded-md border border-gray-gray200 bg-white px-2.5 text-xs font-medium text-gray-gray600 shadow-xs transition-all hover:border-blue-blue hover:bg-blue-blueLight3 hover:text-blue-blue dark:border-gray-gray600 dark:bg-gray-gray800 dark:text-gray-gray200 dark:hover:border-blue-blue dark:hover:bg-gray-gray700"
                >
                    <Icon size={14} />
